<template>
  <div class="min-h-screen bg-gray-50 flex">
    <div class="flex w-full">
      <aside
        class="hidden lg:flex lg:flex-col lg:w-64 lg:h-screen lg:border-r lg:border-gray-200 lg:bg-white lg:sticky lg:top-0">
        <div class="flex flex-col h-full">
          ...
          <div class="shrink-0 border-t border-gray-200 px-4 py-4">
            <div class="flex items-center">
              ...
              <button @click="logout" class="ml-auto text-gray-400 hover:text-gray-500">
