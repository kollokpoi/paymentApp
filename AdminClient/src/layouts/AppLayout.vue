<template>
  <div class="min-h-screen bg-gray-50 flex">
    <div class="flex w-full">
      <aside class="hidden lg:flex lg:flex-col lg:w-64 lg:h-screen lg:border-r lg:border-gray-200 lg:bg-white lg:sticky lg:top-0">
        <div class="flex flex-col h-full">
          ...
          <div class="shrink-0 border-t border-gray-200 px-4 py-4">
            <div class="flex items-center">
              <div class="h-9 w-9 rounded-full bg-linear-to-br from-primary-500 to-primary-700 flex items-center justify-center">
        ...
        <div class="lg:hidden">
          <div class="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3">
            ...
            <router-link to="/" class="flex items-center space-x-2">
              <div class="h-8 w-8 rounded-lg bg-linear-to-br from-primary-600 to-primary-800 flex items-center justify-center">
