        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <InputText
                  ...
                  class="w-full"
                />
                <small class="text-gray-500 text-xs"> URL иконки приложения </small>
              </div>
          ...
          <div>
            ...
            <div class="space-y-4 mb-4">
              <div>
                <label class="block text-sm font-medium mb-2">
                  client_id <span class="text-red-500">*</span>
                </label>
                <InputText
                  v-model="formData.client_id"
                  placeholder="Cтрока из настроек приложения в маркетплейсе"
                  class="w-full"
                  :invalid="!formData.client_id"
                />
                <small v-if="!formData.client_id" class="text-red-500 text-xs">
                  client_id обязателен
                </small>
              </div>
              <div>
                <label class="block text-sm font-medium mb-2">
                  client_secret <span class="text-red-500">*</span>
                </label>
                <InputText
                  v-model="formData.client_secret"
                  placeholder="Cтрока из настроек приложения в маркетплейсе"
                  class="w-full"
                  :invalid="!formData.client_secret"
                />
                <small v-if="!formData.client_secret" class="text-red-500 text-xs">
                  client_secret обязателен
                </small>
              </div>
            </div>
            <div class="space-y-4">
