                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <dl class="space-y-3">
                            ...
                            <EditableEmail required label="Email" v-model:value="editData.email"
                                :is-editing="globalEditing" :type="FieldTypes.Email" @edit-start="startEditing"
                                v-on:validation-change="onValidationChange('email', $event)" />

                            <EditableText label="Новый пароль" v-model:value="editData.password"
                                :is-editing="globalEditing" :type="FieldTypes.Password" @edit-start="startEditing"
                                v-on:validation-change="onValidationChange('password', $event)" />
                            <div>
                                <dt class="text-sm text-gray-500">Email</dt>
                                <dd class="text-gray-900 font-medium">{{ user.role }}</dd>
                            </div>
